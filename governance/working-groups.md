...
<!-- we may need to factor this out, because this describes a mint, which may be used in other places, such as council payments and spending proposal -->
...
<!-- we do not represent deactivated here, since its going away -->
...
<!-- Can you apply more than once as the same member? -->
...
Any role can instantly be removed. The lead can be removed by the council, and a worker can be removed by the lead.
The relevant unstaking period from the policy parameter of the opening from which the role was set applies.
